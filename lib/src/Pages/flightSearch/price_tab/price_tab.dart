...
class _PriceTabState extends State<PriceTab> with TickerProviderStateMixin {
  ...
  final List<FlightStop> _flightStops = [
    FlightStop("TUNISIE", "ATATURK", "JUN 20", "6h 25m", "\$851", "9:26 am - 3:43 pm"),
    FlightStop("DJERBA", "SABIHA \nGÖKCHEN", "JUN 21", "6h 25m", "\$532", "9:26 am - 3:43 pm"),
    FlightStop("MONASTIR", "YESHILKOY \nHAVALANI", "JUN 20", "6h 25m", "\$718", "9:26 am - 3:43 pm"),
  ];
    ...
    return Positioned(
      ...
      child: ScaleTransition(
        ...
        child: FloatingActionButton(
          backgroundColor: googleColor.redColor,
          onPressed: () => Navigator
              .of(context)
